...
const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "6289523258649-1604595598@g.us"}, "message": {orderMessage: {itemCount: 2021,status: 200, thumbnail: fs.readFileSync('./image/sanzy2.jpg'), surface: 200, message: `𝑺𝒂𝒏𝒛𝒚`, orderTitle: 'Please Subscribe Youtube PBS bagas', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
...
url: `https://www.instagram.com/bagass_770/?hl=id`
}
}, {
urlButton: {
displayText: '𝑴𝒚 𝑭𝒂𝒄𝒆𝒃𝒐𝒐𝒌',
url: 'https://www.facebook.com/bagassetiawan.bagassetiawan.779/'
}
}, {
quickReplyButton: {
displayText: '𝑨𝑼𝑫𝑰𝑶',
...
urlButton: {
displayText: '𝒀𝒐𝒖𝒕𝒖𝒃𝒆 𝑶𝒘𝒏𝒆𝒓',
url: 'https://www.youtube.com/channel/UCCX9lXk4DlFNMAezRcN0fbg'
}
}, {
quickReplyButton: {
displayText: '𝑨𝑼𝑫𝑰𝑶',
...
m.reply(mess.wait)
webapi = await fetchJson(api('zeroyt7', '/tiktokvideo', { url: text }, 'apikey'))
zeroyt7.sendMessage(m.chat, { video: { url: webapi.result.result.nowm }, caption: `𝑫𝒐𝒏𝒆.. 𝑫𝒐𝒏'𝒕 𝒇𝒐𝒓𝒈𝒆𝒕 𝒕𝒐 𝒔𝒖𝒃𝒔𝒄𝒓𝒊𝒃𝒆 𝒎𝒚 𝒚𝒐𝒖𝒕𝒖𝒃𝒆 : PBS bagas`}, { quoted: ftroli })
}
break
case 'wm': {
if (!text) throw 'Masukkan Link Tiktok Nya'
m.reply(mess.wait)
webapi = await fetchJson(api('zeroyt7', '/tiktokvideo', { url: text }, 'apikey'))
zeroyt7.sendMessage(m.chat, { video: { url: webapi.result.result.wm }, caption: `𝑫𝒐𝒏𝒆.. 𝑫𝒐𝒏'𝒕 𝒇𝒐𝒓𝒈𝒆𝒕 𝒕𝒐 𝒔𝒖𝒃𝒔𝒄𝒓𝒊𝒃𝒆 𝒎𝒚 𝒚𝒐𝒖𝒕𝒖𝒃𝒆 : PBS bagas`}, { quoted: ftroli })
}
break
case 'mediafiredl': {
...
zeroyt7.sendMessage(m.chat, { image: { url: webapi.result.link }, caption: `𝑫𝒐𝒏𝒆.. 𝑫𝒐𝒏'𝒕 𝒇𝒐𝒓𝒈𝒆𝒕 𝒕𝒐 𝒔𝒖𝒃𝒔𝒄𝒓𝒊𝒃𝒆 𝒎𝒚 𝒚𝒐𝒖𝒕𝒖𝒃𝒆 : PBS bagas`}, { quoted: ftroli })
}
break
case 'igvideo': {
...
zeroyt7.sendMessage(m.chat, { video: { url: webapi.result.link }, caption: `𝑫𝒐𝒏𝒆.. 𝑫𝒐𝒏'𝒕 𝒇𝒐𝒓𝒈𝒆𝒕 𝒕𝒐 𝒔𝒖𝒃𝒔𝒄𝒓𝒊𝒃𝒆 𝒎𝒚 𝒚𝒐𝒖𝒕𝒖𝒃𝒆 : PBS bagas`}, { quoted: ftroli })
}
break
...
m.reply(mess.wait)
webapi = await fetchJson(api('zeroyt7', `/${command}`, {},'apikey'))
zeroyt7.sendMessage(m.chat, { image: { url: webapi.result.url }, caption: `𝑫𝒐𝒏𝒆.. 𝑫𝒐𝒏'𝒕 𝒇𝒐𝒓𝒈𝒆𝒕 𝒕𝒐 𝒔𝒖𝒃𝒔𝒄𝒓𝒊𝒃𝒆 𝒎𝒚 𝒚𝒐𝒖𝒕𝒖𝒃𝒆 : PBS bagas`}, { quoted: ftroli })
}
break
